...
class CreditController extends Controller
{
    ...
    {
        return to_route('credit.index')->with('error', 'There was an error in payment process. Plese try again!');
    }
    ...
    public function webhook()
    {
        ...
        $sig_headers = $_SERVER['HTTP_STRIPE_SIGNATURE'];
        $event = null;
        ...
        switch ($event->type) {
            ...
            default:
                echo 'Receveide unknown event type ' . $event->type;
        }
